...
const CONFIRM_COPY = {
  ...
  permanent: {
    ...
    description:
      "This cannot be undone. The account and its data will be removed for good.",
...
export default function Users() {
  ...
  const handleConfirm = () => {
    ...
    if (type === "ban")
      updateStatus({ id: user.id, isActive: false }, { onSuccess });
